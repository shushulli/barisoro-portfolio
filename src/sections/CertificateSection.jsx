...
export const CertificateSection = () => {
  // Dictionary that stores each cert info
   const certificates = [
  ...
  { id: 10, src: tailwind, alt: "Certificate 10", caption: "Tailwind CSS 4 Essential Training", link: "https://www.linkedin.com/learning/certificates/ee37200c32b68e29447515574c5a2f9bfab16a3d98b4b3362649fca78a7979b3?trk=share_certificate" }
];
...
<header className="text-center relative">
  ...
  <p className="text-sm font-normal leading-relaxed text-white mt-3">
    In this section, I will showcase my certificates
  </p>
</header>
</section>
...
<section className="relative max-w-5xl mx-auto rounded-lg shadow-md border-pink-700 border-t-2 p-2 bg-white -mt-5 z-10">
  ...
  <div className="grid grid-cols-2 md:grid-cols-5  gap-6">
    {/* Each cert object will be assigned to 'cert' and that will be passed to certificatecard component */}
